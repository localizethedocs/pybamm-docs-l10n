...
if     (VERSION_OF_GFORTRAN STREQUAL "[none]")
    set(PACKAGE_OF_GFORTRAN "")
elseif (VERSION_OF_GFORTRAN STREQUAL "")
    set(PACKAGE_OF_GFORTRAN "conda-forge::gfortran")
else()
    set(PACKAGE_OF_GFORTRAN "conda-forge::gfortran=${VERSION_OF_GFORTRAN}")
endif()
if     (VERSION_OF_GRAPHVIZ STREQUAL "[none]")
    set(PACKAGE_OF_GRAPHVIZ "")
elseif (VERSION_OF_GRAPHVIZ STREQUAL "")
    set(PACKAGE_OF_GRAPHVIZ "conda-forge::graphviz")
else()
    set(PACKAGE_OF_GRAPHVIZ "conda-forge::graphviz=${VERSION_OF_GRAPHVIZ}")
endif()
if     (VERSION_OF_OPENBLAS STREQUAL "[none]")
    set(PACKAGE_OF_OPENBLAS "")
elseif (VERSION_OF_OPENBLAS STREQUAL "")
    set(PACKAGE_OF_OPENBLAS "conda-forge::openblas")
else()
    set(PACKAGE_OF_OPENBLAS "conda-forge::openblas=${VERSION_OF_OPENBLAS}")
endif()
if     (VERSION_OF_SUNDIALS STREQUAL "[none]")
    set(PACKAGE_OF_SUNDIALS "")
elseif (VERSION_OF_SUNDIALS STREQUAL "")
    set(PACKAGE_OF_SUNDIALS "conda-forge::sundials")
else()
    set(PACKAGE_OF_SUNDIALS "conda-forge::sundials=${VERSION_OF_SUNDIALS}")
endif()
if     (VERSION_OF_PANDOC STREQUAL "[none]")
    set(PACKAGE_OF_PANDOC "")
elseif (VERSION_OF_PANDOC STREQUAL "")
    set(PACKAGE_OF_PANDOC "conda-forge::pandoc")
else()
    set(PACKAGE_OF_PANDOC "conda-forge::pandoc=${VERSION_OF_PANDOC}")
endif()
remove_cmake_message_indent()
message("")
execute_process(
...
message(STATUS "Running 'uv export' command to export the requirements...")
...
message(STATUS "Running 'uv pip install' command to install the requirements...")
if (CMAKE_HOST_LINUX)
